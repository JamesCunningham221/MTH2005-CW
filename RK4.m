...
figure(1)
plot(t, r*10^(6), 'LineWidth',2, 'Color', 'r')
xlabel('Time (s)', 'FontSize',15);
ylabel('Droplet Radius (m)', 'FontSize',15);
title('Droplet Growth Over Time', 'FontSize',15);
grid on;%--------------------------------------------
hold on
plot(t, r_FE*10^(6), "Color", 'b', 'LineStyle',':', 'LineWidth',2)
plot(t, rstar*10^(6), "Color", 'g', 'LineStyle','-.', 'LineWidth',2)
legend('RK4', 'FE', 'FontSize', 15)
