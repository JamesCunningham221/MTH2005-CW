...
ylabel('Cloud Top Droplet Radius (m)');
title('Cloud Top Droplet Radius vs Initial Vertical Velocity');
...
ylabel('Cloud Top Droplet Radius (m)');
title('Cloud Top Droplet Radius vs Initial Droplet Radius');
...
xlabel('Initial Droplet Number Concentration (m^{-3})');
ylabel('Cloud Top Droplet Radius (m)');
title('Cloud Top Droplet Radius vs Initial Droplet Number Concentration', FontSize= 8);
...
xlabel('Initial Droplet Number Concentration (m^{-3})');
ylabel('Max Supersaturation');
title('Max Supersaturation vs Initial Droplet Number Concentration', FontSize= 9)